module.exports=[13348,a=>{"use strict";let b=[{slug:"how-often-should-you-have-an-eye-test",title:"How Often Should You Have an Eye Test? — Age-by-Age Advice",excerpt:"From toddlers to over-70s, the recommended frequency of eye tests varies by age, health, and risk factors. Learn exactly when to book your next appointment.",image:"/images/optician-shop-sm.jpg",category:"Eye Health",readTime:"7 min read",publishDate:"2025-11-18",content:`## Why regular eye tests matter
...
Finally, keep a record of your eye test appointments and set reminders so you never fall behind schedule. Many opticians will send you a reminder when your next test is due, but it is worth taking responsibility for your own eye health rather than relying solely on these notifications. If you have children, add their eye test to your family health calendar alongside dental check-ups and other routine appointments. Regular eye care is a small commitment that pays enormous dividends for your vision and overall wellbeing.`},{slug:"what-happens-during-an-eye-test",title:"What Happens During an Eye Test? A Step-by-Step Guide",excerpt:"Nervous about your eye test? Walk through every stage of a modern UK eye examination, from the history questions to the final prescription.",image:"/images/eye-test-phoropter-sm.jpg",category:"Guides",readTime:"8 min read",publishDate:"2025-10-25",content:`## Before your appointment
...
Finally, file your prescription in a safe place and make a note in your diary or phone to book your next eye test when it falls due. Building regular eye tests into your health routine is one of the simplest and most effective ways to protect your vision and monitor your overall health for years to come.`},{slug:"signs-you-need-an-eye-test",title:"10 Signs You Need an Eye Test",excerpt:"Headaches, squinting, and holding your phone at arm's length? Discover the key warning signs that it's time to visit your optician.",image:"/images/oct-scan-sm.jpg",category:"Eye Health",readTime:"6 min read",publishDate:"2025-09-30",content:`## Why you should not ignore vision changes
...
Most importantly, make eye tests a normal, routine part of your family's healthcare calendar, just like dental check-ups and vaccinations. By normalising regular eye care from an early age, you are giving your child the best possible foundation for a lifetime of clear, comfortable vision.`},{slug:"understanding-your-eye-test-results",title:"Understanding Your Eye Test Results & Prescription",excerpt:"SPH, CYL, AXIS, ADD -- your prescription card can look like a foreign language. This plain-English guide decodes every number and abbreviation.",image:"/images/retinal-scan-sm.jpg",category:"Guides",readTime:"8 min read",publishDate:"2025-07-20",content:`## Why it pays to understand your prescription
...
If your optometrist mentions terms like cup-to-disc ratio (used in glaucoma assessment), drusen (deposits associated with macular degeneration), or nuclear sclerosis (early cataract changes), do not hesitate to ask for a clear explanation in everyday language. A good optometrist will be happy to explain their findings and what they mean for your eye health going forward. Knowledge is power, and the more you understand about your results, the more actively you can participate in looking after your vision.`},{slug:"nhs-vs-private-eye-tests",title:"NHS vs Private Eye Tests: What’s the Difference?",excerpt:"Should you use your free NHS entitlement or pay for a private eye test? Compare what each includes, who qualifies, and which offers better value.",image:"/images/elderly-eye-test-sm.jpg",category:"NHS",readTime:"7 min read",publishDate:"2025-06-15",content:`## The basics: what each type includes
...
Whatever you decide, the most important thing is to have your eyes tested regularly. Whether NHS or private, a comprehensive eye test is one of the most valuable health checks available in the UK, providing vital information about both your vision and your general health. Use our search tool to find opticians near you, compare their services, and book an appointment today.`}];a.s(["articles",0,b,"getAllArticleSlugs",0,function(){return b.map(a=>a.slug)},"getAllArticles",0,function(){return b},"getArticleBySlug",0,function(a){return b.find(b=>b.slug===a)}])}];

//# sourceMappingURL=Documents_Claude_Projects_eyetest_co_uk_src_data_articles_ts_0ggugbx._.js.map