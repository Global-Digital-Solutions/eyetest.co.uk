...
export const locations: UKLocation[] = [
  ...
  { slug: "watford", name: "Watford", county: "Hertfordshire", region: "South East", population: 96800, lat: 51.6565, lng: -0.3903, postcode: "WD17 2NW", description: "Find eye tests in Watford. Compare opticians in the intu Centre, High Street, and across Hertfordshire.", nearbyAreas: ["st-albans", "london", "luton", "slough"] },
