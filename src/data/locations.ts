...
export const locations: UKLocation[] = [
  ...
  { slug: "basingstoke", name: "Basingstoke", county: "Hampshire", region: "South East", population: 113776, lat: 51.2667, lng: -1.0879, postcode: "RG21 7EB", description: "Find eye tests in Basingstoke. Compare opticians at Festival Place, the town centre, and beyond.", nearbyAreas: ["reading", "winchester", "andover", "newbury"] },
  ...
  { slug: "worthing", name: "Worthing", county: "West Sussex", region: "South East", population: 109000, lat: 50.8147, lng: -0.3714, postcode: "BN11 1LJ", description: "Book eye tests in Worthing. Compare opticians along the seafront and town centre.", nearbyAreas: ["brighton", "chichester", "crawley"] },
  ...
  { slug: "blackpool", name: "Blackpool", county: "Lancashire", region: "North West", population: 139720, lat: 53.8142, lng: -3.0503, postcode: "FY1 1AD", description: "Book eye tests in Blackpool. Compare opticians on the promenade, town centre, and across the Fylde Coast.", nearbyAreas: ["preston", "lancaster", "lytham-st-annes", "fleetwood"] },
  ...
  { slug: "sunderland", name: "Sunderland", county: "Tyne and Wear", region: "North East", population: 174286, lat: 54.9069, lng: -1.3838, postcode: "SR1 3JB", description: "Compare eye tests in Sunderland. Find opticians in the Bridges, High Street, and across Wearside.", nearbyAreas: ["newcastle", "durham", "south-shields", "hartlepool"] },
  ...
  { slug: "middlesbrough", name: "Middlesbrough", county: "North Yorkshire", region: "North East", population: 140545, lat: 54.5746, lng: -1.2356, postcode: "TS1 2NQ", description: "Find eye tests in Middlesbrough. Compare opticians in the Cleveland Centre and across Teesside.", nearbyAreas: ["darlington", "stockton-on-tees", "redcar", "hartlepool"] },
